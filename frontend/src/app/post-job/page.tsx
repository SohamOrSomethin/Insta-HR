  ...
  return (
    <main className='min-h-screen bg-gray-50 pt-16'>
      <div className='max-w-3xl mx-auto px-6 py-10'>
        ...
        {message && (
          <div className='bg-green-50 text-green-700 px-4 py-3 rounded-xl mb-6 font-medium'>{message}</div>
        )}
          ...
          <div className='bg-white rounded-2xl p-6 shadow-sm border border-gray-100'>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div>
                ...
                <input name='experienceMin' value={formData.experienceMin} onChange={handleChange} type='number' placeholder='0'
                  className='w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-blue-500 transition-all' />
              </div>
              <div>
                <label className='block text-sm font-medium text-gray-700 mb-2'>Max Experience (years)</label>
                <input name='experienceMax' value={formData.experienceMax} onChange={handleChange} type='number' placeholder='5'
                  className='w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-blue-500 transition-all' />
              </div>
              <div>
                <label className='block text-sm font-medium text-gray-700 mb-2'>Min Salary (₹/month)</label>
                <input name='salaryMin' value={formData.salaryMin} onChange={handleChange} type='number' placeholder='30000'
                  className='w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-blue-500 transition-all' />
              </div>
              <div>
                <label className='block text-sm font-medium text-gray-700 mb-2'>Max Salary (₹/month)</label>
                <input name='salaryMax' value={formData.salaryMax} onChange={handleChange} type='number' placeholder='80000'
                  className='w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-blue-500 transition-all' />
              </div>
            </div>
          </div>
          <div className='bg-white rounded-2xl p-6 shadow-sm border border-gray-100'>
            ...
            <div className='space-y-4'>
              <div>
                ...
                <input name='skills' value={formData.skills} onChange={handleChange} placeholder='React, Node.js, PostgreSQL'
                  className='w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-blue-500 transition-all' />
              </div>
              <div>
                <label className='block text-sm font-medium text-gray-700 mb-2'>Job Description *</label>
                <textarea name='description' value={formData.description} onChange={handleChange}
                  placeholder='Describe the role, responsibilities and requirements...' required rows={6}
